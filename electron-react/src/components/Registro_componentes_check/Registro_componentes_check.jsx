...
export const Registro_componentes_check = () => {
  ...
  const fetchUltimaMaquina = async () => {
    try {
      const response = await axios.get(
        `${process.env.REACT_APP_API_BASE_URL}/ultimaMaquina`
      );
  ...
  const fetchComponentes = async () => {
    try {
      const response = await axios.get(
        `${process.env.REACT_APP_API_BASE_URL}/componenteChecklist`
      );
      setComponentes(response.data);
    } catch (error) {
      console.error(
        "Error al obtener la lista de componentes del checklist",
        error
      );
    }
  };
  ...
  const RegistrarComponente = async () => {
    try {
      ...
      const response = await axios.post(
        `${process.env.REACT_APP_API_BASE_URL}/registerComponenteChecklist`,
        {
