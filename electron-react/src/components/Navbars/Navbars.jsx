      ...
      <div className="navVertical">
        ...
        <div className="listMaquinas">
          ...
          {tipoMaquina ? tipoMaquina.map(tipoM => {
            return <div className="tipoMaquina" onClick={() => { hiddenMenu(tipoM.id_tipo_maquina) }} key={tipoM.id_tipo_maquina}>
              <div className="tipoMaquinaN text-gray-800 hover:text-gray-200 focus:bg-gray-200">
