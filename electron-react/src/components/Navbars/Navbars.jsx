      ...
      <div className="navVertical">
        ...
        <div className="listMaquinas">
          ...
          {tipoMaquina ? tipoMaquina.map(tipoM => {
            return <div className="tipoMaquina" onClick={() => { hiddenMenu(tipoM.id_tipo_maquina) }}>
              <div className="tipoMaquinaN text-gray-800 hover:text-gray-200 focus:bg-gray-200" key={tipoM.id_tipo_maquina}>
              ...
              <div className="listMaquinasN hidden" id={tipoM.id_tipo_maquina} onClick={() => { hiddenMenu(tipoM.id_tipo_maquina) }}>
        ...
        <div className="adminMaquina">
          ...
          <div className="herramientaMaquinaN text-gray-800 hover:text-gray-200">
            ...
            <h3 className='text-lg'>Maquinas</h3>
          </div>
        </div>
      </div>
